...
onMounted(() => {
  const $chartArea = document.querySelector("#columnChart")

  if ($chartArea && typeof ApexCharts !== 'undefined') {
  ...
  <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
      <div class="flex items-center">
        <div class=" rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center me-3">
